...
import { IMTAsyncHashFunction, IMTMerkleProof, IMTNode } from "./types"
...
export default class AsyncIMT {
     ...
     * @returns True if the leaf is part of the tree, and false otherwise.
     */
    public static async verifyProof(proof: IMTMerkleProof, hash: IMTAsyncHashFunction): Promise<boolean> {
